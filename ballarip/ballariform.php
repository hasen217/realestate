...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO referrals (location_source, name, email, phone, address, property, property_location, source, message)
            VALUES ('Ballari', '$name','$email','$phone','$address','$property','$property_location','$source','$message')";
...
<title>Refer a Friend - Ballari Real Estate</title>
...
<div class="container">
    ...
    <form id="refForm" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="property_location" value="<?php echo (!empty($prefilled_loc) ? "Ballari, " . $prefilled_loc : ''); ?>" required placeholder="Enter the full property address">
        </div>
...
<div class="back-container">
    <a href="../ballarip/ballari.php" class="back">← Back to Ballari Hub</a>
    <a href="../myproject.php" class="back">Back to Home page Hub</a>
</div>
...
<div id="successPopup" class="modal-overlay">
  <div class="modal-content">
    ...
    <h3>Success!</h3>
    <p>Thank you! Your property referral has been submitted successfully to the Ballari team.</p>
...
<div id="receiptTemplate" style="display:none; padding:40px; background:white; color:black; font-family:'Outfit', sans-serif;">
    <h1 style="color:#4361ee; text-align:center; font-size:28px; margin-bottom:10px;">Ballari Real Estate</h1>
...
function downloadReceipt() {
    ...
    const opt = {
      margin:       0.5,
      filename:     'Ballari_Referral_Receipt.pdf',
