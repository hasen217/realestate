...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $area_size = !empty($_POST['area']) ? intval($_POST['area']) : 0;
...
<div class="container">
    <div class="form-side">
        <a href="cowlbazaar.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Listing</a>
        <div class="form-card">
            <h1>Add Property</h1>
            ...
            <?php if ($message): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form method="POST" action="add_cowlbazaar.php" enctype="multipart/form-data" id="addForm">
