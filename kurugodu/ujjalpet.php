...
<head>
    ...
    <title>Ujjalpet Road Properties</title>
    <style>
...
<body>
    <h1>This is the Ujjalpet Road Properties</h1>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Ujjalpet Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
