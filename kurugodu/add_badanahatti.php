...
<div class="container">
    <div class="form-side">
        <a href="badanahattiroad.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Listing</a>
        <div class="form-card">
            <h1>Add Property</h1>
            ...
            <?php if ($message): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form method="POST" action="add_badanahatti.php" enctype="multipart/form-data" id="addForm">
                ...
                <div class="form-grid-mobile" style="display:grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group"><label>Property Type</label><select name="type" class="form-control" required><option value="house/home">House/Home</option><option value="plot/land">Plot/Land</option><option value="apartment">Apartment</option><option value="commercial">Commercial</option></select></div>
