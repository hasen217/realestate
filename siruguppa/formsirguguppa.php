...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO referrals (location_source, name, email, phone, address, property, property_location, source, message)
            VALUES ('Siruguppa', '$name','$email','$phone','$address','$property','$property_location','$source','$message')";
...
<title>Refer a Friend - Siruguppa Real Estate</title>
...
<div class="container">
    ...
    <form id="refForm" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="property_location" value="<?php echo (!empty($prefilled_loc) ? "Siruguppa, " . $prefilled_loc : ''); ?>" required placeholder="Enter the full property address">
        </div>

        <div class="form-group">
            <label>How did you hear about us?</label>
            <input type="text" name="source" placeholder="e.g. Google, Friend, Advertisement">
        </div>
...
<div class="back-container">
    <a href="../siruguppa/siruguppa.php" class="back">← Back to Siruguppa Hub</a>
...
<div id="receiptTemplate" style="display:none; padding:40px; background:white; color:black; font-family:'Outfit', sans-serif;">
    <h1 style="color:#4361ee; text-align:center; font-size:28px; margin-bottom:10px;">Siruguppa Real Estate</h1>
...
function downloadReceipt() {
    ...
    const opt = {
      margin:       0.5,
      filename:     'Siruguppa_Referral_Receipt.pdf',
