...
<head>
    ...
    <title>Siruguppa Real Estate Management</title>
    <style>
...
<body>
    <h1>This is the Siruguppa Real Estate Management</h1>

    <nav>
        <div class="nav-links">
            <a href="../myproject.php">Home</a>
            <a href="../siruguppa/siruguppform.php">Contact</a>
            <a href="#map">Map</a>
        </div>
        ...
        <div class="search-container">
            <select id="locationSelect" onchange="searchProperty()">
                ...
                <option value="Deshnur Road">Deshnur Road</option>
                <option value="ballari road">Ballari Road</option>
                <option value="Moulana Azad School Rood">Moulana Azad School</option>
                <option value="sindhanur road">Sindhanur Road</option>
                <option value="adoni road">Adoni Road</option>
            </select>
    ...
    <div class="locations-grid">
        <section class="box" data-location="Deshnur Road">
            <a href="../siruguppa/deshnurroad.php">
                <h2><strong>Deshnur Road</strong></h2>
                <p>Deshnur Road, and Deshnur</p>
            </a>
        </section>

        <section class="box" data-location="ballari road">
            <a href="../siruguppa/ballariroad.php">
                <h2><strong>Ballari Road</strong></h2>
                <p>VKj collage, shantiniketana collage near available</p>
            </a>
        </section>

        <section class="box" data-location="adoni road">
            <a href="../siruguppa/adoniroad.php">
                <h2><strong>Adoni Road</strong></h2>
                <p>Gandi circle, old police station, taluk office, govt hospital</p>
            </a>
        </section>

        <section class="box" data-location="sindhanur road">
            <a href="../siruguppa/sindhanurroad.php">
                <h2><strong>Sindhanur Road</strong></h2>
                <p>Tipp sultan circle, taluk office, government hospital Rode available</p>
            </a>
        </section>

        <section class="box" data-location="Moulana Azad School Rood">
            <a href="../siruguppa/moulan azad school.php">
                <h2><strong>Moulana Azad School Road</strong></h2>
                <p>Royel Ladkan masjid, Nagraj Hotel available</p>
            </a>
        </section>
    </div>

    <!-- MAP SECTION -->
    <h2 class="title">Siruguppa Karnataka Map</h2>
    <div id="map" class="map-container">
        <iframe 
            src="https://maps.google.com/maps?q=Siruguppa%20Karnataka&t=&z=13&ie=UTF8&iwloc=&output=embed"
            frameborder="0"
            scrolling="no"
            marginheight="0"
            marginwidth="0">
