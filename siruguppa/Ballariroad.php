...
<body>
    ...
    <div class="properties">
        <div class="card">
            ...
            <h3>Home Rent</h3>
            <p>Location: Balaji Theater near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Home+Rent&property_image=../siruguppa/homerent.jpg&property_location=Balaji Theater near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../siruguppa/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Bus Stand near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Plot&property_image=../siruguppa/plot.jpg&property_location=Bus Stand near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../siruguppa/homesale.webp" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: VKJ Collage near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Home+Sale&property_image=../siruguppa/homesale.webp&property_location=VKJ Collage near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../siruguppa/landsale1.jpg" alt="Land Sale">  
            <h3>Land Sale</h3>
            <p>Location: Santiniketan Collage near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Land+Sale&property_image=../siruguppa/landsale1.jpg&property_location=Santiniketan Collage near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../siruguppa/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: New Police Station near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Home+Rent&property_image=../siruguppa/homerent2.jpg&property_location=New Police Station near"><button>Book Now</button></a>
        </div>
