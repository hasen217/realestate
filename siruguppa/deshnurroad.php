...
<head>
    ...
    <title>Deshnur Road Properties</title>
    <style>
...
<body>
    <h1>This is the Deshnur Road Properties</h1>
    ...
    <div class="properties">
        <div class="card">
            ...
            <p>Price: ₹5,000 /mo</p>
            <a href="../siruguppa/formsirguguppa.php?property_title=Home+Rent&property_image=../siruguppa/homerent.jpg&property_location=Deshnur road seter gudi near"><button>Book Now</button></a>
        </div>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Deshnur Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
