...
<head>
    ...
    <title>Gangavathi Road Properties</title>
    <style>
...
<body>
    <h1>This is the Gangavathi Road Properties</h1>
    ...
    <div class="properties">
        ...
        $area_filter = "Gangavati Road";
        $stmt = $pdo->prepare("SELECT * FROM properties WHERE (LOWER(address) LIKE ? OR LOWER(description) LIKE ?) AND LOWER(city) LIKE '%kampli%' ORDER BY id DESC");
        $stmt->execute(["%" . strtolower($area_filter) . "%", "%" . strtolower($area_filter) . "%"]);
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Gangavathi Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
