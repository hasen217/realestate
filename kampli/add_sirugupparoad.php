...
<div class="container">
    <div class="form-side">
        <a href="siruguppa road.php" class="back-link"><i class="fas fa-arrow-left"></i> Back to Listing</a>
        <div class="form-card">
            <h1>Add Property</h1>
            ...
            <?php if ($message): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <form method="POST" action="add_sirugupparoad.php" enctype="multipart/form-data" id="addForm">
