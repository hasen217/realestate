...
<head>
    ...
    <title>Busstand Area Properties</title>
    <style>
...
<body>
    <h1>This is the Busstand Area Properties</h1>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Busstand Area, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
