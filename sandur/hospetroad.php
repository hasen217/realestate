...
<head>
    ...
    <title>Hospet Road Properties</title>
    <style>
...
<body>
    <h1>This is the Hospet Road Properties</h1>
    ...
    <div class="properties">
        <div class="card">
            ...
            <h3>Home Rent</h3>
            <p>Location: Basava bavan near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent1.jpg&property_location=Basava+bavan+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Rajesh mobile shop near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Plot&property_image=../sandur/plot.jpg&property_location=Rajesh+mobile+shop+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/homerent1.jpg" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: Hanuman Temple near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Home+Sale&property_image=../sandur/homesale.jpg&property_location=Hanuman+Temple+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/land.jpg" alt="Land Sale">  
            <h3>Land Sale</h3>
            <p>Location: Urdu School near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Land+Sale&property_image=../sandur/land.jpg&property_location=Urdu+School+near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../sandur/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Sankar Hotel near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent2.jpg&property_location=Sankar+Hotel+near"><button>Book Now</button></a>
        </div>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Hospet Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
