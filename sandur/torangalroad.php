...
<head>
    ...
    <title>Torangal Road Properties</title>
    <style>
...
<body>
    <h1>This is the Torangal Road Properties</h1>
    ...
    <div class="properties">
        <div class="card">
            ...
            <h3>Home Rent</h3>
            <p>Location: Quick Xerox Shop near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent1.jpg&property_location=Quick+Xerox+Shop+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Royal Pan Shop near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Plot&property_image=../sandur/plot.jpg&property_location=Royal+Pan+Shop+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/homesale.jpg" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: Lakshmi Temple near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Home+Sale&property_image=../sandur/homesale.jpg&property_location=Lakshmi+Temple+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/land.jpg" alt="Land Sale">  
            <h3>Land Sale</h3>
            <p>Location: Raju Bookstal near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Land+Sale&property_image=../sandur/land.jpg&property_location=Raju+Bookstal+near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../sandur/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Aone Function Hall near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent2.jpg&property_location=Aone+Function+Hall+near"><button>Book Now</button></a>
        </div>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Torangal Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
