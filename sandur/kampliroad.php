...
<head>
    ...
    <title>Kampli Road Properties</title>
    <style>
...
<body>
    <h1>This is the Kampli Road Properties</h1>
    ...
    <div class="properties">
        <div class="card">
            ...
            <h3>Home Rent</h3>
            <p>Location: Lalu Hotel near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent1.jpg&property_location=Lalu+Hotel+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Santosh Hotel near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Plot&property_image=../sandur/plot.jpg&property_location=Santosh+Hotel+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/homesale.jpg" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: Guru Function Hall near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Home+Sale&property_image=../sandur/homesale.jpg&property_location=Guru+Function+Hall+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/land.jpg" alt="Land Sale">  
            <h3>Land Sale</h3>
            <p>Location: Government High School near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Land+Sale&property_image=../sandur/land.jpg&property_location=Government+High+School+near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../sandur/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Ravi Bookstal near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent2.jpg&property_location=Ravi+Bookstal+near"><button>Book Now</button></a>
        </div>
    ...
    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Kampli Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
