...
<head>
    ...
    <title>Kudligi Road Properties</title>
    <style>
...
<body>
    <h1>This is the Kudligi Road Properties</h1>

    <nav>
        <div class="nav-links">
            <a href="../sandur/sandur.php">Home</a>
    ...
    <div class="properties">
        <div class="card">
            <img src="../sandur/homerent1.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Madusudan Hospital near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent1.jpg&property_location=Madusudan+Hospital+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Nehru Viddya Mandiran School near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Plot&property_image=../sandur/plot.jpg&property_location=Nehru+Viddya+Mandiran+School+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/homesale.jpg" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: Babu Hotel near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Home+Sale&property_image=../sandur/homesale.jpg&property_location=Babu+Hotel+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/land.jpg" alt="Land Sale">  
            <h3>Land Sale</h3>
            <p>Location: Police Station Road near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Land+Sale&property_image=../sandur/land.jpg&property_location=Police+Station+Road+near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../sandur/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Markazi Masjid near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent2.jpg&property_location=Markazi+Masjid+near"><button>Book Now</button></a>
        </div>
        
        <?php foreach ($db_properties as $property): 
            $images = json_decode($property['images'], true);
            $first_image = !empty($images) ? '../' . $images[0] : '../sandur/homerent1.jpg';
            $booking_url = "../sandur/sandurform.php?" . http_build_query([
    ...
    <div class="action-buttons">
        <a href="../sandur/sandur.php"><button class="a">Back</button></a>
        <a href="../myproject.php"><button class="b">Home</button></a>
    </div>

    <!-- FOOTER -->
    <footer>
        © 2026 All Rights Reserved. These properties belong to the Kudligi Road side, including houses, plots, apartments, and rental buildings. Please contact our department for details.
    </footer>
