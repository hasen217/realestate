...
<body>
    ...
    <div class="properties">
        <div class="card">
            ...
            <h3>Home Rent</h3>
            <p>Location: Mahaveer colony near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent1.jpg&property_location=Mahaveer+colony+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/plot.jpg" alt="Plot">
            <h3>Plot</h3>
            <p>Location: Tayamma Temple near</p>
            <p>Price: ₹40,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Plot&property_image=../sandur/plot.jpg&property_location=Tayamma+Temple+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/homesale.jpg" alt="Home Sale">
            <h3>Home Sale</h3>
            <p>Location: Saanvi Hospital near</p>
            <p>Price: ₹20,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Home+Sale&property_image=../sandur/homesale.jpg&property_location=Saanvi+Hospital+near"><button>Book Now</button></a>
        </div>
        
        <div class="card">
            <img src="../sandur/land.jpg" alt="Land Sale">
            <h3>Land Sale</h3>
            <p>Location: Sharan Hotel near</p>
            <p>Price: ₹10,00,000</p>
            <a href="../sandur/sandurform.php?property_title=Land+Sale&property_image=../sandur/land.jpg&property_location=Sharan+Hotel+near"><button>Book Now</button></a>
        </div>

        <div class="card">
            <img src="../sandur/homerent2.jpg" alt="Home Rent">
            <h3>Home Rent</h3>
            <p>Location: Ambabai Temple near</p>
            <p>Price: ₹5,000 /mo</p>
            <a href="../sandur/sandurform.php?property_title=Home+Rent&property_image=../sandur/homerent2.jpg&property_location=Ambabai+Temple+near"><button>Book Now</button></a>
        </div>
